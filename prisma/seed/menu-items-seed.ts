    ...
    for (const role of roles) {
      for (const menuItem of allMenuItems) {
        ...
        // Administrator gets most permissions except super admin specific
          ...
          const canAccess = !menuItem.permission?.includes('admin:system');
          await prisma.role_menu_items.create({
            data: {
              roleId: role.id,
              menuItemId: menuItem.id,
        ...
        // HR Manager gets HR specific permissions
          ...
          const canAccess = menuItem.permission?.includes('read:hrm') ||
        ...
        // Employee gets basic permissions
          ...
          const canAccess = menuItem.permission === 'read:dashboard' ||
