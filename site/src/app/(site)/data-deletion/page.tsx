      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            Hướng dẫn này cung cấp các bước để người dùng hoặc quản trị viên xóa dữ liệu cá nhân khỏi hệ thống, đảm bảo tuân thủ quyền riêng tư và các quy định pháp luật liên quan.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 mt-4">
              <p className="text-yellow-800 dark:text-yellow-200">
                <strong>Lưu ý:</strong> Một số dữ liệu có thể được giữ lại trong 30 ngày để tuân thủ các yêu cầu pháp lý (ví dụ: hóa đơn, hợp đồng theo quy định tại Việt Nam hoặc quốc tế). Sau thời gian này, dữ liệu sẽ được xóa hoàn toàn.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-3 pl-4 text-gray-700 dark:text-gray-300">
              <li><strong className="text-gray-900 dark:text-white">Sao lưu dữ liệu:</strong> Trước khi yêu cầu xóa, hãy sao lưu mọi thông tin quan trọng (ví dụ: tài liệu, hình ảnh) vì quá trình xóa là <strong className="text-red-600 dark:text-red-400">không thể khôi phục</strong>.</li>
              <li><strong className="text-gray-900 dark:text-white">Tác động đến dịch vụ:</strong> Sau khi xóa dữ liệu, bạn sẽ mất quyền truy cập vào các dịch vụ liên quan đến tài khoản (ví dụ: nội dung đã lưu, lịch sử mua hàng).</li>
              <li><strong className="text-gray-900 dark:text-white">Tài khoản liên kết:</strong> Nếu tài khoản của bạn được liên kết với các dịch vụ bên thứ ba (Google, Facebook, v.v.), bạn cần xóa liên kết riêng biệt trên các nền tảng đó.</li>
              <li><strong className="text-gray-900 dark:text-white">Thời gian xử lý:</strong> Yêu cầu xóa dữ liệu sẽ được xử lý trong vòng 30 ngày làm việc. Bạn sẽ nhận được email xác nhận khi quá trình hoàn tất.</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-3">
              Theo các quy định về bảo vệ dữ liệu (như GDPR hoặc Luật An ninh mạng Việt Nam), bạn có quyền:
            </p>
            <ul className="list-disc list-inside space-y-2 pl-4 text-gray-700 dark:text-gray-300">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Chúng tôi cam kết xử lý dữ liệu người dùng theo đúng quy định pháp luật hiện hành, bao gồm nhưng không giới hạn ở Luật An ninh mạng Việt Nam và các quy định quốc tế như GDPR (nếu áp dụng).
            </p>
          </div>

          <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 p-4">
            <p className="text-red-800 dark:text-red-200">
              <strong>Cảnh báo:</strong> Việc sử dụng dịch vụ sau khi yêu cầu xóa dữ liệu (ví dụ: đăng nhập lại) có thể tạo ra bản ghi mới trong hệ thống. Hãy đảm bảo bạn không đăng nhập lại nếu muốn dữ liệu được xóa hoàn toàn.
            </p>
          </div>
        </section>
      </div>
