    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your access levels across all TazaCore business modules</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(MODULE_DESCRIPTIONS).map(([moduleId, description]) => {
              ...
              return (
                <div
                  key={moduleId}
                  className={`p-4 border rounded-lg ${hasAccess ? 'bg-background' : 'bg-muted/50'}`}
                >
                  <div className="flex items-center justify-between mb-2">
      ...
      {user && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Complete breakdown of your system permissions</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
