...
const AttendanceManagement: React.FC = () => {
    ...
    if (attendance) {
      ...
      setFormData({
        ...
        breakStart: attendance.breakStart
          ? attendance.breakStart.substring(11, 16)
          : '',
        breakEnd: attendance.breakEnd
          ? attendance.breakEnd.substring(11, 16)
          : '',
  ...
  const filteredAttendances = attendances.filter(attendance => {
    ...
    const matchesDate =
      !dateFilter || attendance.date.split('T')[0] === dateFilter;
          ...
          filteredAttendances.map(attendance => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  <img
                    ...
                    src={
                      attendance.employee.user?.avatar ||
                      `https://ui-avatars.com/api/?name=${attendance.employee.fullName}&background=3b82f6&color=fff`
                    }
              ...
              <div className="flex justify-between items-center">
                <span
                  className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusBadgeColor(attendance.status)}`}
                >
