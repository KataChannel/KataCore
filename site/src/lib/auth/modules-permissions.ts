...
export const SALES_PERMISSIONS = {
  ...
  SALES_ANALYTICS: { action: 'read', resource: 'sales_analytics', description: 'View sales analytics' },
...
export const INVENTORY_PERMISSIONS = {
  ...
  // Purchase Orders
  PURCHASE_ORDER_READ: { action: 'read', resource: 'purchase_order', description: 'View purchase orders' },
  PURCHASE_ORDER_CREATE: { action: 'create', resource: 'purchase_order', description: 'Create purchase orders' },
  PURCHASE_ORDER_APPROVE: { action: 'approve', resource: 'purchase_order', description: 'Approve purchase orders' },
  ...
  // Inventory Reports
  INVENTORY_REPORTS: { action: 'read', resource: 'inventory_reports', description: 'View inventory reports' },
...
export const FINANCE_PERMISSIONS = {
  ...
  ACCOUNT_MANAGE: { action: 'manage', resource: 'account', description: 'Manage chart of accounts' },
  JOURNAL_ENTRY: { action: 'create', resource: 'journal_entry', description: 'Create journal entries' },
  
  // Financial Reports
  FINANCIAL_REPORTS: { action: 'read', resource: 'financial_reports', description: 'View financial reports' },
...
export const HRM_PERMISSIONS = {
  ...
  // Performance
  PERFORMANCE_READ: { action: 'read', resource: 'performance', description: 'View performance reviews' },
  PERFORMANCE_MANAGE: { action: 'manage', resource: 'performance', description: 'Manage performance reviews' },
...
export const PROJECT_PERMISSIONS = {
  ...
  // Project Reports
  PROJECT_REPORTS: { action: 'read', resource: 'project_reports', description: 'View project reports' },
  RESOURCE_PLANNING: { action: 'read', resource: 'resource_planning', description: 'View resource planning' },
} as const;

// Manufacturing Permissions
export const MANUFACTURING_PERMISSIONS = {
  // Production Planning
  PRODUCTION_PLAN_READ: { action: 'read', resource: 'production_plan', description: 'View production plans' },
  PRODUCTION_PLAN_CREATE: { action: 'create', resource: 'production_plan', description: 'Create production plans' },
  PRODUCTION_PLAN_APPROVE: { action: 'approve', resource: 'production_plan', description: 'Approve production plans' },
  
  // Work Orders
  WORK_ORDER_READ: { action: 'read', resource: 'work_order', description: 'View work orders' },
  WORK_ORDER_CREATE: { action: 'create', resource: 'work_order', description: 'Create work orders' },
  WORK_ORDER_UPDATE: { action: 'update', resource: 'work_order', description: 'Update work orders' },
  WORK_ORDER_COMPLETE: { action: 'complete', resource: 'work_order', description: 'Complete work orders' },
  ...
  QC_MANAGE: { action: 'manage', resource: 'quality_control', description: 'Manage quality control' },
  
  // Manufacturing Reports
  MFG_REPORTS: { action: 'read', resource: 'manufacturing_reports', description: 'View manufacturing reports' },
  EFFICIENCY_REPORTS: { action: 'read', resource: 'efficiency_reports', description: 'View efficiency reports' },
} as const;

// Marketing Permissions
export const MARKETING_PERMISSIONS = {
  // Campaign Management
  CAMPAIGN_READ: { action: 'read', resource: 'marketing_campaign', description: 'View marketing campaigns' },
  CAMPAIGN_CREATE: { action: 'create', resource: 'marketing_campaign', description: 'Create campaigns' },
  CAMPAIGN_MANAGE: { action: 'manage', resource: 'marketing_campaign', description: 'Manage campaigns' },
  ...
  SOCIAL_MEDIA_MANAGE: { action: 'manage', resource: 'social_media', description: 'Manage social media' },
  SOCIAL_MEDIA_POST: { action: 'post', resource: 'social_media', description: 'Post to social media' },
  
  // Email Marketing
  EMAIL_CAMPAIGN_READ: { action: 'read', resource: 'email_campaign', description: 'View email campaigns' },
  EMAIL_CAMPAIGN_CREATE: { action: 'create', resource: 'email_campaign', description: 'Create email campaigns' },
  EMAIL_CAMPAIGN_SEND: { action: 'send', resource: 'email_campaign', description: 'Send email campaigns' },
  
  // Marketing Analytics
  MARKETING_ANALYTICS: { action: 'read', resource: 'marketing_analytics', description: 'View marketing analytics' },
  MARKETING_REPORTS: { action: 'read', resource: 'marketing_reports', description: 'View marketing reports' },
} as const;
...
export const SUPPORT_PERMISSIONS = {
  ...
  CUSTOMER_CHAT: { action: 'chat', resource: 'customer_communication', description: 'Chat with customers' },
  CUSTOMER_EMAIL: { action: 'email', resource: 'customer_communication', description: 'Email customers' },
  
  // Support Reports
  SUPPORT_REPORTS: { action: 'read', resource: 'support_reports', description: 'View support reports' },
...
export const ANALYTICS_PERMISSIONS = {
  ...
  DASHBOARD_CUSTOMIZE: { action: 'customize', resource: 'dashboard', description: 'Customize dashboards' },
  ...
  ADVANCED_ANALYTICS: { action: 'advanced_analyze', resource: 'data', description: 'Advanced analytics' },
  
  // Business Intelligence
  BI_READ: { action: 'read', resource: 'business_intelligence', description: 'View BI reports' },
  BI_CREATE: { action: 'create', resource: 'business_intelligence', description: 'Create BI reports' },
} as const;
...
export const ECOMMERCE_PERMISSIONS = {
  ...
  // Online Orders
  ONLINE_ORDER_READ: { action: 'read', resource: 'online_order', description: 'View online orders' },
  ONLINE_ORDER_PROCESS: { action: 'process', resource: 'online_order', description: 'Process online orders' },
  ONLINE_ORDER_FULFILL: { action: 'fulfill', resource: 'online_order', description: 'Fulfill orders' },
  ...
  ECOMMERCE_ANALYTICS: { action: 'read', resource: 'ecommerce_analytics', description: 'View e-commerce analytics' },
  CONVERSION_REPORTS: { action: 'read', resource: 'conversion_reports', description: 'View conversion reports' },
} as const;
...
export const SYSTEM_ROLES: UserRole[] = [
  // Super Administrator
  {
    ...
    permissions: Object.values(ALL_MODULE_PERMISSIONS).map(permission => ({ ...permission, scope: 'all' as const })),
  },
