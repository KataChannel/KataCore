...
project_cleanup_and_container_fix() {
    ...
    if [ "$overwrite_data" = true ]; then
        info "💡 Project data has been overwritten - you may want to deploy now to restart services"
    else
        info "💡 You may want to deploy the application now to restart services"
    fi
}
